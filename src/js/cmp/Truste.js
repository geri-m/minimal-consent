...
export default class Truste extends CMP {
    ...
    handleCmp() {
        ...
        let divTruste = super.node.querySelector(trusteBoxOverlay);
        let minimalConsentButton = super.node.querySelector(super.minimalConsentLink);
        ...
        if (Utils.objectClickable(divTruste) && this.state === 0) {
        ...
        } else if (Utils.objectClickable(minimalConsentButton) && this.state === 1) {
        ...
        let divTrusteV2 = super.node.querySelector(trusteSimpleOverlay);

        const closeButton = "img[alt*='close button']";
        let buttomTrusteV2 = super.node.querySelector(closeButton);

        if (Utils.objectClickable(divTrusteV2) && this.state === 0) {
            divTrusteV2.click();
